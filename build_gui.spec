...
a = Analysis(
    ...
    datas=[
        ...
        (str(PROJECT_ROOT / "engines" / "seed_keywords.json"), "engines"),
        (str(PROJECT_ROOT / "闲鱼标题剔除词.txt"), "."),
    ...
    hiddenimports=[
        ...
        "engines.ai_client",
        "engines.category_profiles",
        "engines.flywheel_engine",
        "engines.pdd_ddk_api",
        "engines.pdd_search_optimizer",
        "engines.pipeline_manager",
        "engines.scoring_evolution",
        "engines.self_learner",
        "engines.parallel_pipeline",
        "core.global_rate_limiter",
        "core.foreground_scheduler",
        "gui",
        "gui.app",
        "gui.theme",
        "gui.tabs",
